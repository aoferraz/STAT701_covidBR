...
# Calculate ventilators per capita
ventilators_tot <- ventilators_tot %>%
  left_join(pop[,c("city_code","pop.2020")], by = "city_code") %>%
    mutate(n.totalper100K_03.2020 = ventilators.total_03.2020/pop.2020 * 100000, #assuming pop 2021 = pop 2020
...
#ventilators <- data.frame(lapply(ventilators, as.numeric))
