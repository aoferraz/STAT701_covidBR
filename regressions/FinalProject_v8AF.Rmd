---
title: "Covid in Brazil and associated variables"
...
Brazil confirmed its first case of Covid-19 in February 26,2020. 15 months after the outbreak, the country sees more 15M of cases and  more than 420,000 deaths. Since February, Brazil is the country with more daily new deaths per population and the third in terms of total cases, after the US and India.
...
It is important to understand what was done wrong and right. This study sought to investigate Brazil's structural factors and Covid-response related measures that can be associated with total Covid deaths in the country up to now (pandemic data used as of April 19, 2021).

With a regression model in hands, we identified important factors of Covid death and cases, measured their potential impact and evaluated the performance of counties and states in terms of actual vs predicted results.


## Data and methodology

Our project team compiled **260 different variables for each of the 5,570 counties in Brazil**, after consolidating information of more than 80 databases, from 10 different data sources.

Independent variables were divided into 6 categories: Covid-response related, geographic, population, economic, health and political. 

We performed multiple regression analyses at county level, using LASSO regularization and Mallows' Cp statistics, to identify significant independent variables and develop a linear model associating deaths to relevant factors.


## Findings

The regression analysis revealed 20 significant variables which can associated with total deaths (log of deaths per 100k inhabitants). 

Brazil is still a very poor country, and cities with more low income and vulnerable people seemed to suffer more causalities. Population variables compose the majority of significant variables. Some of them are percentage of population with 50 to 69 years, urban density, percentage of 'pardos*' and indigenous people in the population, rural population, access to cleaned water, number of rooms in the house, and others.

In the economic category, formal and informal employment rates were the most relevant variables. The Covid emergency financial aid, funded by the federal government, also presented positive association with deaths, which might imply that the program was properly target to the most needed people.

Health variables were also important. 2nd doses vaccine shots per capita, specialty beds per 100k inhabitants, nurses per 100k inhabitants and coverage of private health plans presented significance and positive correlation, while cities with more hospital beds per 100k inhabitants had fewer deaths.

Finally, cities with higher percentage of votes in Jair Bolsonaro (currrent president of Brazil), also presented higher Covid deaths rates, with relevant significance.

It is always important to notice that correlation doe not imply causation, but this study is a good indication that Covid hit Brazilian cities differently according to their structural factors and Covid response initiatives.
...
![](fig/country_comparison_deathsperpop.png)

![](fig/country_comparison_totalcases.png)
...
Correlation is not causation, but might be a good indicative of where to start to look.
...
- It has 26 states and 1 Federal District (where the capital Brasília is the only municipality), so there are 27 territories part of the Federation
...
- The Southeast is the richest region of Brazil, which translates into better income and education levels. São Paulo is the business center of the country and concentrates industry, services and consumption volumes
...
- 50% of the economically active population is formally employed, so there is a relevant share of informal jobs and a current high unemployment rate (14%), driven by the pandemic but mainly by political-economic downturn of 2014
- Almost 60% of the population receives direct or indirect support of the Federal Government through the 'Bolsa-Família' program, a social welfare program for poor families. Financial aid amount varies according to the number of family profile, number and age of children
...
- Presidential elections have direct votes, disputed by all candidates in the first round, and by the 2 most voted in the 2nd round (if the most voted candidate in the 1st round does not achieve 50% + 1 of valid votes)
...
As a response for the catastrophic number of cases and deaths, there has been an increasing criticism about the overall response of authorities, of different levels and sectors, to the crisis. The overall reaction was seen as late, limited, disorganized and disoriented.
...
From a health perspective, the main initiatives taken were the expansion of the assistance network (beds, equipment, staff) and the vaccine program (started on January 17, 2020).
  
    

## Goal of the study

Understanding the gravity of the Covid pandemic in Brazil, its important internal diversity and structural differences, and the responses taken so far, this study seeks to investigate structural factors and Covid-response related measures that can be associated with total Covid deaths in the country (pandemic data used as of April 19, 2021).
...
With the model in hands, we can identified important factors of Covid death and cases, measured their potential impact and evaluated the performance of counties and states in terms of actual vs predicted results.
...
- Cumulative deaths per 100k inhabitants (independent variable)
...
We transformed deaths per 100k inhabitant to log in order to improve the model. 

![](fig/analytic_approach.jpg)


The first complete regression run with the 5,570 counties led to multiple outliers that skewed the residual distribution. The majority of outliers were small counties (less than 3k people), with zero or very few deaths. These counties usually do not treat patients, but transfer them to other locations. To avoid noise and control outlier, we removed those observation from the subsequent analysis, presented in this report. So our regression model was built and is valid for counties with more than kk inhabitants in Brazil.
...
The descriptions of the dataframes created and their variables are bellow:
